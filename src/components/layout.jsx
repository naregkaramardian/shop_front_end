            ...
            <div className='relative flex-1 flex flex-col max-w-xs w-full bg-indigo-700'>
              ...
              <div className='flex-1 h-0 pt-5 pb-4 overflow-y-auto'>
                ...
                <nav className='mt-5 px-2 space-y-1'>
                  {navigation.map((item) => (
                    <a key={item.name} href={item.href} className={classNames(item.current ? 'bg-indigo-800 text-white' : 'text-white hover:bg-indigo-600 hover:bg-opacity-75', 'group flex items-center px-2 py-2 text-base font-medium rounded-md')}>
          ...
          <div className='flex flex-col h-0 flex-1'>
            <div className='flex-1 flex flex-col pt-5 pb-4 overflow-y-auto'>
              ...
              <nav className='mt-5 flex-1 px-2 space-y-1'>
                {navigation.map((item) => (
                  <a key={item.name} href={item.href} className={classNames(item.current ? 'bg-indigo-800 text-white' : 'text-white hover:bg-indigo-600 hover:bg-opacity-75', 'group flex items-center px-2 py-2 text-sm font-medium rounded-md')}>
